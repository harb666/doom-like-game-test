...
const [type = 'ally', pose = 'idle', dist = '3', turn = '0'] = process.argv.slice(2);
...
await page.evaluate(async ([type, pose, dist, turn]) => {
...
await page.screenshot({ path: `close-${type}-${pose}.png` });
await browser.close();
