...
const SOUNDS = {
  ...
  hellmawSight: (s) => { s.growl(75, 55, 1.3, 420, 14, 0.7, 0.4); s.noise({ dur: 0.9, vol: 0.4, type: 'lowpass', f: 900, f2: 200, at: 0.3 }); },
  hellmawPain: (s) => s.growl(120, 85, 0.35, 500, 18, 0.55, 0.3),
  hellmawDeath: (s) => { s.growl(95, 30, 1.5, 380, 8, 0.7, 0.4); s.noise({ dur: 0.7, vol: 0.5, type: 'lowpass', f: 700, at: 0.9 }); },
  hellmawIdle: (s) => s.growl(60, 55, 0.9, 330, 20, 0.35, 0.3),
  ravagerSight: (s) => { s.growl(110, 70, 0.9, 700, 9, 0.7, 0.45); s.noise({ dur: 0.5, vol: 0.3, type: 'bandpass', f: 1500, q: 2 }); },
  ravagerPain: (s) => s.growl(160, 110, 0.3, 900, 14, 0.55, 0.4),
  ravagerDeath: (s) => s.growl(130, 40, 1.3, 650, 6, 0.7, 0.4),
  ravagerIdle: (s) => s.growl(80, 72, 0.7, 500, 25, 0.35, 0.35),
