...
export const WEAPONS = [
  ...
  {
    id: 'scattergun', slot: 2, name: 'Breacher Scattergun',
  ...
  {
    id: 'repeater', slot: 3, name: 'Buzzsaw Repeater',
  ...
  {
    id: 'lancer', slot: 4, name: 'Ion Lancer',
  ...
  {
    id: 'hellbore', slot: 5, name: 'Hellbore Launcher',
...
export const PROJECTILES = {
  plasma:  { speed: 42, radius: 0.18, color: 0x66ccff, size: 0.55, light: true, impact: 'plasma' },
  rocket:  { speed: 24, radius: 0.22, color: 0xffa040, size: 0.6, trail: true, impact: 'explosion', splash: { radius: 4.5, damage: 110 } },
  acid:    { speed: 13, radius: 0.25, color: 0x8aff40, size: 0.7, impact: 'acid' },
  ember:   { speed: 16, radius: 0.25, color: 0xff7020, size: 0.8, trail: true, impact: 'ember' },
  hellfire:{ speed: 17, radius: 0.35, color: 0xff3010, size: 1.1, trail: true, impact: 'explosion', splash: { radius: 3.5, damage: 60 } },
};
